...
namespace vkInit{
	...
	*/
    ...
    vk::Device create_logical_device(vk::PhysicalDevice physicalDevice, vk::SurfaceKHR vulkanSurface, bool debug){
	...
	*/
	std::array<vk::Queue,2> get_queues(vk::PhysicalDevice physicalDevice, vk::Device device, vk::SurfaceKHR vulkanSurface, bool debug) {
